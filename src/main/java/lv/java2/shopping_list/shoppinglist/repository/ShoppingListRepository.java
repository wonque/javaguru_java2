...
public interface ShoppingListRepository {
    ...
    Optional<ShoppingList> findById(Long accountId, Long listId);

    Optional<ShoppingList> findByAccountAndTitle(Account account, String title);

    boolean remove(ShoppingList shoppingList);

    List<ShoppingList> findAllListsByAccountId (Long accountId);

    Optional<ShoppingList> findByAccountIdAndTitle(Long accountId, String title);
