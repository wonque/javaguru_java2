...
public class AccountRepositoryIntegrationTest {
    ...
    public void testAtrueIfAdded() {
        ...
        account.setEmail("poooooo@foo.bar");
    ...
    public void testA_falseIfLoginDoesNotExists() {
        Optional<Account> founded = accountRepository.findByEmail("somelogin");
        assertFalse(founded.isPresent());
    }

    @Test
    public void testB_trueIfLoginExists() {
        Optional<Account> founded = accountRepository.findByEmail("login@foo.bar");
